...
<head>
    ...
    <title>Kelola Admin & UKM - Superadmin</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css  " rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css  " rel="stylesheet">
    <style>
        body { background: #f5f6fa; }
        .sidebar {
            height: 100vh; background: #2c3e50; padding-top: 20px; color: white;
            position: fixed; left: 0; top: 0; z-index: 1000;
        }
        .sidebar a {
            padding: 12px; display: block; color: white; text-decoration: none; font-weight: 500;
        }
                                ...
                                <?php if (!empty($records)): ?>
                                    <?php foreach ($records as $r): ?>
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($r['ukm_email'] ?? $r['admin_email'] ?? '—') ?></td>
                                            <td>
                                                <?php if ($r['ukm_status']): ?>
                                            ...
                                            <td>
                                                <a href="?action=edit&id=<?= $r['admin_id'] ?>" class="btn btn-sm btn-warning">
