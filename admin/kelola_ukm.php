<?php
// admin/kelola_ukm.php — VERSI DENGAN LAYOUT TERPADU
...
$page_title = "Kelola UKM - " . htmlspecialchars($ukm['nama_ukm']);
$nama_ukm = htmlspecialchars($ukm['nama_ukm']); // Untuk navbar: "Admin [Nama UKM]"
?>
